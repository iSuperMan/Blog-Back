 ...
 */
schema.path('hashedPassword').validate(function bar() {
 ...
 * Set random salt
 */
schema.methods.setSalt = function bar() {
 ...
 * @return {String}
 */
schema.methods.encryptPassword = function bar(password) {
 ...
 * @return {Bool}
 */
schema.methods.checkPassword = function bar(password) {
